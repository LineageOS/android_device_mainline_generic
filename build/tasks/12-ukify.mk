...
define make-ukify-out
	PATH=/usr/local/bin:/usr/bin:/bin ukify build --efi-arch=$(UKIFY_EFI_ARCH) --linux=$(PRODUCT_OUT)/kernel --initrd=$(PRODUCT_OUT)/ramdisk.img --cmdline=$(OUT_CMDLINE_TXT) --output=$(1)
endef
