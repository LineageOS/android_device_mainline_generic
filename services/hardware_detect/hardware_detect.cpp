...
const std::set<std::string> kDrmSysfbNames = {"efidrm", "ofdrm", "simpledrm", "vesadrm"};
const std::set<std::string> kBasicDrmCards = {"gud", "udl", "hyperv_drm"};
const std::set<std::string> kMustUseFbDisplayCards = {"vboxvideo"};
